...
const char* googleScriptURL = "https://script.google.com/macros/s/AKfycbzWphbim0zWUsFUjIM9X-1GdNkVObZN8qPP0jY_UBYGOSIMc_nOiRqoAnUQZFI1HvFuw/exec";
...
void setup() {
  ...
  // Nuevo endpoint para controlar el actuador (LED azul)
